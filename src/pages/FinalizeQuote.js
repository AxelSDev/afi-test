const FinalizeQuote = () => (
  <div className="text-left w-11/12 text-lg">
    <p className="mb-5">Judge, we just emailed and texted you a pdf of the quote.</p>
    <b className="text-xl">Here are the next steps to finalize your quote.</b>
    <div className="mt-5 w-fit flex items-center font-bold text-2xl py-2 px-4 text-blue-900 border-blue-900 rounded-full border-2">1</div>
    ...
    <div className="mt-5 w-fit flex items-center font-bold text-2xl py-2 px-4 text-blue-900 border-blue-900 rounded-full border-2">2</div>
    <p>An agent from our team will reach out to you soon to get the above information from you to finalize the quote.</p>
    <div className="mt-5 w-fit flex items-center font-bold text-2xl py-2 px-4 text-blue-900 border-blue-900 rounded-full border-2">3</div>
